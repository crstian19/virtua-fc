...
<div>
    <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 py-6 md:py-10">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-4 sm:p-6 md:p-8 space-y-8">
                ...
                @if($isChampion)
                <div class="text-center py-5 md:py-6 bg-amber-50 rounded-lg border border-amber-200/60">
                    <x-team-crest :team="$game->team" class="w-14 h-14 md:w-16 md:h-16 mx-auto mb-2" />
                    <h2 class="text-xl md:text-2xl font-black text-amber-700 tracking-tight">
